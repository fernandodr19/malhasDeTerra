...
void CableType::load(QSettings *settings)
{
    ...
    m_saleUnit = (CableTypeSaleUnit)settings->value("saleUnit", CableTypeSaleUnit_Kilometer).toInt();
}

void CableType::save(QSettings *settings, bool saveTemporary)
{
...
bool CableType::validate(Project *project, QString& error)
{
//    bool ok;
...
//    if(project->hasModule(Application::Module_CableTypeACResistance)) {
...
//    if(project->hasModule(Application::Module_CableTypeInternalReactance)) {
...
//    if(project->hasModule(Application::Module_CableTypeCrossSection)) {
...
//    if(project->hasModule(Application::Module_CableTypeLinearWeight)) {
...
//    if(project->hasModule(Application::Module_CableTypeTensileStrength)) {
...
//    if(project->hasModule(Application::Module_CableTypeInitialElasticModulus)) {
...
//    if(project->hasModule(Application::Module_CableTypeLinearExpansionCoeff)) {
...
//    if(project->hasModule(Application::Module_CableTypeCurrentCapacity) && isShieldWire()) {
...
QString CableType::getTranslatedType()
{
    if(m_type == "AAC")
